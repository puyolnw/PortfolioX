...
import {
  DataGrid, type GridColDef, type GridPaginationModel, type GridRowsProp, type GridValidRowModel,
} from '@mui/x-data-grid';
import CustomPagination from '@/demo/villagefund/components/sections/dashboard/invoice/CustomPagination';
import NoData from '@/demo/villagefund/components/sections/dashboard/invoice/NoData';
import RenderCellDescription from '@/demo/villagefund/components/sections/dashboard/invoice/RenderCellDescription';
import RenderCellDownload from '@/demo/villagefund/components/sections/dashboard/invoice/RenderCellDownload';
import { invoiceRowData, type RowData } from '@/demo/villagefund/data/invoice-data';
import { currencyFormat, dateFormatFromUTC } from '@/demo/villagefund/helpers/utils';
...
const InvoiceOverviewTable: React.FC = () => {
  ...
  // แก้ไข useEffect เพื่อป้องกัน infinite loop
useEffect(() => {
  ...
  handleDataFiltering();
}, [value]); // เพิ่ม dependency array ที่ชัดเจน
