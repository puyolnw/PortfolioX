                              ...
                              <div className="tgmenu__categories select-grp-two d-none d-md-block">
                                 <div className="dropdown">
                                    ...
                                    <ul className="dropdown-menu">
                                       <li><Link className="dropdown-" to="/courses">Business</Link></li>
                                       <li><Link className="dropdown-" to="/courses">Data Science</Link></li>
                                       <li><Link className="dropdown-" to="/courses">Art & Design</Link></li>
                                       <li><Link className="dropdown-" to="/courses">Marketing</Link></li>
                                       <li><Link className="dropdown-" to="/courses">Finance</Link></li>
                                    </ul>
                                 </div>
                              </div>
