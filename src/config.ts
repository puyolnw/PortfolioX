...
export const skillsData: Skill[] = [
  ...
  { 
    ...
    descriptionTh: 'Code editor หลักพร้อม extensions',
  },
  { 
    name: 'Postman', 
  ...
  { 
    name: 'Excel', 
    icon: 'logos:microsoft-excel', 
    category: 'tools', 
    color: '#217346',
    proficiency: 'high',
    description: 'Data analysis and reporting',
    descriptionTh: 'Data analysis และ reporting',
  },
];
...
export const projectsData: Project[] = [
  {
    ...
    techStack: ['React', 'Node.js', 'MongoDB', 'Express', 'OpenCV', 'MUI'],
    images: [
  ...
  },
  {
    ...
    images: [
      '/images/mooc-preview.png',
      '/images/mooc-logo.png',
      '/images/rmu-logo.png',
    ],
  },
  {
